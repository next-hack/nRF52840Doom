...
typedef struct
{
    short sprite; /* sprite number to show                       */
    short frame; /* which frame/subframe of the sprite is shown */
    short tics; /* number of gametics this frame should last   */
    actionf_t action; /* code pointer to function for action if any  */
    short nextstate; /* linked list pointer to next state or zero   */
    short misc1, misc2; /* apparently never used in DOOM               */
