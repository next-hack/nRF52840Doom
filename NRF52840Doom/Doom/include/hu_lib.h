...
typedef struct
{
    ...
    short nl;                          // height in lines
    short nr;                          // total height in rows
    short cl;                          // current line number

    short x, y, w, h;                         // window position and size
...
void HUlib_initSText(hu_stext_t *s, short x, short y, short h, const patch_t *font, short startchar, //jff 2/16/98 add color range parameter
boolean *on);
