 ...
 *
 *  next-hack: added MF_DECORATION flag, to identify those objects
 *  that are static (like MF_SPECIAL), and do not require full mobj_t structure.
 *  This saves 96 bytes/mobj with respect to GBA port.
 *-----------------------------------------------------------------------------
 */
